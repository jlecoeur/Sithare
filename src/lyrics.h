...
class Lyrics
{
	public:
		...
		bool fetchSeekLyrics();         // set as private after debug
		bool fetchAliveLyrics();        // set as private after debug
		bool fetchFrCopyLyrics();        // set as private after debug
		std::string getArtist();
		std::string getTitle();
		std::string getLyrics();
		void freeLyrics();
		std::string saveLyrics(std::string fileName);
	...
	private:
		...
		std::string getSeekLyricsURL();
		std::string getAliveLyricsURL();
		std::string getFrCopyLyricsURL();
		std::string artist;
		std::string title;
		std::string lyrics;
